                            ...
                            <div class="assets-form">
                                <div class="consumption-form-table pay">
                                    <span style="color: red;size: 12px;font-weight:bold;">
                                        线上提现失败，请确认是否有其他网络问题，如有其他问题请联系客服！
                                    </span>
                                    <hr />
                                    <div>
                                           <span>
                                            ...
                                            <span style="font-weight: bold">提现不成功金额：</span><span></span>
                                    </div>
                                    <br>
                                    <input type="button" id="returnWithdraw" value="确定">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="recharge" class="col-md-10 personal-center-content">
                        <div role="tabpanel" class="tab-pane" id="recharges-form">
                            <div class="assets-form">
                                <div class="consumption-form-table pay">
                                    <span style="color: red;size: 12px;font-weight:bold;">
                                        线上充值失败，请确认是否有其他网络问题，如有其他问题请联系客服！
                                    </span>
                                        <hr />
                                    <label>充值金额：</label>
                                       <div>
                                           ...
                                           <span style="font-weight: bold">充值不成功金额：</span><span></span>
                                       </div>

                                    <br>
                                    <input type="button" id="returnRecharge" value="确定">
                                </div>
                            </div>
                        </div>
                    </div>
