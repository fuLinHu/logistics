                ...
                <div class="row">
                    ...
                    <div class="col-md-10 personal-center-content">
                        <div class="info-diffusion-add2">
                            <form class="form-horizontal" id="carUpdateForm">
                                <h3>修改车辆</h3>
                                <div class="form-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input id="drivingCardPhotosZ" name="drivingCardPhotosZ" type="hidden" value="${carInformation.drivingCardPhotosZ}"/>
                                            <input id="drivingCardPhotosF" name="drivingCardPhotosF" type="hidden" value="${carInformation.drivingCardPhotosF}"/>
                                            <input id="carFrontPhoto" name="carFrontPhoto" type="hidden" value="${carInformation.carFrontPhoto}"/>
                                            <input id="transportProvePhoto" name="transportProvePhoto" type="hidden" value="${carInformation.transportProvePhoto}"/>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="form-2">
                                                    ...
                                                    <div class="upload">
                                                        ...
                                                        <script>
                                                            document.getElementById("cardPhotosF").onchange=function(){
                                                                ...
                                                                $.ajax({
                                                                    url:'../testCar/${pageContext.request.contextPath }/fileManage/carImageUpload',
                                                                    data:formData2,
                                                                    type:'post',
                                                                    async: false,
                                                                    cache: false,
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <script>
                                            function updateCar() {
                                                 var a = $("input:hidden[name='id1']").val();
                                                alert(a);
                                                $.ajax({
                                                    type: "post",
                                                    url: "${pageContext.request.contextPath }/vehicleSource/updateCarInformation",
                                                    data: $("#carUpdateForm").serialize()+$("#driverSaveForm").serialize(),
                                                    async: true,
