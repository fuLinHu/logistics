...
<body>
            ...
            <div class="index-my-ssc">
                ...
                <div class="notice">
                    ...
                    <ul class="notice-list">
                        <li>
                            <a href="${pageContext.request.contextPath}/home/build?type=3" style="text-decoration:underline">【2018-05-21】 关于经维路通物流平台上线试运行的通知</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/home/build?type=3" style="text-decoration:underline">【2018-05-25】 关于用户信息更新认证的通知</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/home/build?type=3" style="text-decoration:underline">【2018-06-01】 官方声明</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/home/build?type=3" style="text-decoration:underline">【2018-06-02】 文明上网倡议书</a>
                        </li>
                    </ul>
                </div>
                <div class="button">
        ...
        <div class="container">
            ...
            <div style="float: left;width: 50%">
                ...
                <ul style="font-size:14px;margin-top: 16px;list-style-type: disc;margin-left: 45px">
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">数字化拼箱服务即将来袭，您准备好了吗？</a><br><br>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">区块连海事保险平台来了</a><br><br>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">超大型集装箱船再添新丁 “中远海运室女座”上午交付</a><br><br>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">重磅！商务部、财政部联合发布《关于开展2018年流通领域现代供应链体系建设的通知》</a>
                    </li>
                </ul>
            </div>
            <div style="float: right;width: 50%">
                ...
                <ul style="font-size:14px;margin-top: 16px;list-style-type: disc;margin-left: 45px">
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">5月20日上午，天津一商集团有限公司外部董事张XX一行在我司总经理赵XXX陪同下莅临公司总部调研。</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">5月21日上午，我司正式与中远海运集装箱运输有限公司天津滨海分公司签署战略合作协议框架。</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">5月23日下午我司召开第一次市场工作会议，总部领导班子、各部门经理及市场部全体员工参加。</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/home/build?type=6">5月28日上午，宝钢集团外部董事张XX一行在我司总经理赵XXX陪同下莅临公司总部调研。</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <footer class="main-footer">
        ...
        <p class="text-center footer-bottom"> 版权所有：经维（天津）物流有限公司&nbsp;&nbsp;
            ...
            <%--<a href="${pageContext.request.contextPath}/home/test">请问请问群无翁群二阿萨德</a>--%>
        </p>
    </footer>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                url:"${pageContext.request.contextPath}/imageManage/getShipDynamic",
                type:"post",
                dataType:"json",
                success:function(data){
                    var str ="";
