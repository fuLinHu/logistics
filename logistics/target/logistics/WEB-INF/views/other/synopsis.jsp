            ...
            <div class="row">
                <div class="col-md-7">
                    <div>
                        ...
                        <p>  </p>
                        <p>  </p>
                        <p>咨询电话：012-12345678</p>
                        <p>  </p>
                        <p>客服QQ：1376587625</p>
                        <p>  </p>
                        <p>官方微信：changshitongwx</p>
                        <p>  </p>
                        <p>邮箱：info@sscunion.com</p>
                        <p>  </p>
                        <p>地址：天津和平区五大道街经贸中心</p>
                        <p>  </p>
                        <p>邮编：300100</p>
                        <p>  </p>
                        <p>  </p>
                ...
                <div class="col-md-5">
                    <div>
                        <img <%--class="fix-img"--%> src="${pageContext.request.contextPath}/static/img/lianxikefu2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
