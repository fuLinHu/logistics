                                            ...
                                            <c:forEach items="${requestScope.orderList}" var="obj">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <c:if test="${obj.ordersFlag==3}">收货未支付</c:if>
                                                        <c:if test="${obj.ordersFlag==4}">收货未支付</c:if>
                                                        <c:if test="${obj.ordersFlag==5}">收货未支付</c:if>
                                                        <c:if test="${obj.ordersFlag==6}">收货未支付</c:if>
                                                        <c:if test="${obj.ordersFlag==7}">订单已支付</c:if>
                                                    </td>
                                                    <td>${obj.userName}</td>
