                                        ...
                                        <tbody>
                                            <td>
                                                ...
                                                <td class="item-block-3" width="10%">
                                                    <div>￥<c:if test="${empty obj.offer}">- -</c:if>${obj.offer}</div>
                                                </td>
                                                <td class="item-block-3" width="10%">
                                            ...
                                            <td class="item-block-4" width="10%">
                                                <c:if test="${obj.ordersFlag ==201 && sessionScope.userFront.accountType==2}">
                                                    <a href="${pageContext.request.contextPath}/order/deliverGoods?id=${obj.id}">确认发货</a><br>
                                                </c:if>
                                                <c:if test="${obj.ordersFlag ==202 && sessionScope.userFront.accountType==1}">
                                                    <a href="${pageContext.request.contextPath}/order/collectGoods?id=${obj.id}">确认收货</a><br>
                                                </c:if>
                                                <a href="#" onclick="detail(${obj.id})"  >订单详情</a><br>
                                                <a href="#" onclick="evaluation(${obj.id})"  >订单评价</a><br>
