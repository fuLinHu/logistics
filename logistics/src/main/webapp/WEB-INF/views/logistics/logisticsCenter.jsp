                                    ...
                                    <li>
                                        <c:if test="${'1'eq sessionScope.userFront.accountType }">
                                            ...
                                            <c:if test="${'1' eq land.flag}">
                                                <div style="padding-left: 55px"><button class="btn btn-primary1" onclick="" type="button">已抢</button></div>
                                            </c:if>
                                        </c:if>
                                    </li>
                                </ul>
            ...
            <div class="pagination-other clearfloat">
                ...
                <div class="pagination-other-2">
                    ...
                    <select id="logistiscSelectPage" class="form-control">
                        <option value="10" <c:if test="${requestScope.pageSize ==10}">selected = "selected"</c:if>>8</option>
                        <option value="15" <c:if test="${requestScope.pageSize ==15}">selected = "selected"</c:if>>16</option>
                        <option value="20" <c:if test="${requestScope.pageSize ==20}">selected = "selected"</c:if>>32</option>
                    </select>
                    <span>页</span>
                </div>
