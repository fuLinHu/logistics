...
<div class="sub-header">
    ...
    <div class="body-logistics-center-search">
        <div class="logistics-search-bg">
            <img src="../../../static/img/logistics-center-bg3.jpg" alt="">
        </div>
            ...
            <div class="logistics-search clearfloat">
                <div class="col-md-3">
                    <ul class="logistics-search-nav">
                        <li>
                            <a href="${pageContext.request.contextPath }/transportation/index">汽运运力</a>
                        </li>
                        <li class="active">
                            <a href="#">汽运货源</a>
                        </li>
                ...
                <div class="col-md-9">
                    <div class="logistics-search-form">
                        <form class="form-horizontal" action="${pageContext.request.contextPath }/releaseSource/releaseSourceList" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">起运地址：</label>
                                <div class="col-sm-9">
                                    <input id="startAddress" name="startAddress" type="text" class="form-control" placeholder="起运地址">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">目的地址：</label>
                                <div class="col-sm-9">
                                    <input id="arriveAddress" name="arriveAddress" type="text" class="form-control" placeholder="目的地址">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">货物名称：</label>
                                <div class="col-sm-9">
                                    <input id="goods" name="goods" type="text" class="form-control" placeholder="货物名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">货量：</label>
                                <div class="col-sm-9">
                                    <div class="clearfix logistics-wight">
                                        <div class="pull-left wight">
                                            <input id="startWight" name="startWight" onkeyup="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}" type="text" class="form-control" placeholder="货物重量">
                                        </div>
                                        <div class="pull-left line">~</div>
                                        <div class="pull-left wight">
                                            <input id="endWeight" name="endWeight" type="text" onkeyup="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}" class="form-control" placeholder="货物重量">
                                        </div>
                                        <div class="pull-left unit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="startTime" name="startTime" type="date" class="form-control" placeholder="装货开始时间">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">装货结束时间：</label>
                                <div class="col-sm-9">
                                    <input id="endTime" name="endTime" type="date" class="form-control" placeholder="装货结束时间">
                                </div>
                            </div>
                            <%--<div class="form-group">
