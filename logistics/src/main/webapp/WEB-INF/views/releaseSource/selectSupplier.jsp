                            ...
                            <div class="user-information-nav">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active">
                                        <a href="#information-form" aria-controls="information-form" role="tab" data-toggle="tab">选择供应商</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="information-form">
                                    <div class="user-information-form">
                                        <form id="froID" action="${pageContext.request.contextPath}/releaseSource/releaseSourceOk" class="form-horizontal" method="post">
                                            <input type="hidden" id="sourceId" name="id" value="${requestScope.id}">
                                            ...
                                            <c:forEach items="${requestScope.list}" var="obj" varStatus="status">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="pluckId" value="${obj.id}"> 报价：￥${obj.amount}&nbsp;元&nbsp;&nbsp;，${obj.carrierName}
                                                    </label>
                                                </div>
                                            </c:forEach>
                                            ...
                                            <a style="margin-top: 150px" href="${pageContext.request.contextPath}/releaseSource/releaseSource" class="btn btn-primary">返回</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
