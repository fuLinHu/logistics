                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="button-1">
                                                                <c:if test="${landTransportation.status == 1}">
                                                                    <a type="button" href="${pageContext.request.contextPath}/vehicleSource/goSelectSource?id=${landTransportation.id}"  class="btn btn-default">选择货源</a>
                                                                </c:if>
                                                               <%-- <script>
                                    ...
                                    <div class="order-release land-car car-management">
                                        ...
                                        <div class="order-release-content">
                                            ...
                                            <div class="item">
                                                ...
                                                <p class="item-state">状态：<c:if test="${carInfo.statu==1}">已保存</c:if>
