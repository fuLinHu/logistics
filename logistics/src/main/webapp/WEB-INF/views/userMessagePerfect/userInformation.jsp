                                    ...
                                    <div class="user-information-form">
                                        <form id="userPersonageFromID" action="<%=request.getContextPath()%>/userMessagePerfect/userPersonageInsert" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" maxlength="18" <%--pattern="[0-9]"--%> name="idcard" readonly  value="${sessionScope.userFront.userMessage}" class="form-control" placeholder="身份证号">
                                                </div>
                                            </div>
                                            <div class="order-information-1">
                                    ...
                                    <div class="user-information-form">
                                        <form id="userCompanyFromID" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" readonly value="${sessionScope.userFront.userMessage}<%--${firm[0].enterpriseName}--%>" name="enterpriseName" placeholder="企业名称">
                                                </div>
                                            </div>
                                            <%--<div class="form-group">--%>
