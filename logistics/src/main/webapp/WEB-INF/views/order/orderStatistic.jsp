                        ...
                        <div class="asset-center-nav">
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#consumption-form" aria-controls="consumption-form" role="tab" data-toggle="tab">订单统计</a>
                                </li>
                            ...
                            <div role="tabpanel" class="tab-pane" id="assets-form">
                                <div class="assets-form">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>未匹配</td>
                                            <td> ${requestScope.count1}</td>
                                            <td>--</td>
                                        </tr>
                                        <tr>
                                            <td>运输中</td>
                                            <td> ${requestScope.count2} </td>
                                            <td>--</td>
                                        </tr>
                                        <tr>
                                            <td>未支付</td>
...
<script type="text/javascript">
    function button() {
        ...
        var type = $("#type").val();
        var url="${pageContext.request.contextPath}/order/toOrderStatistic?pageNo="+pageNo+"&pageSize="+select
    ...
    function homepage() {
        ...
        var orderType = $("#orderType").val();
        var type = $("#type").val();
        var url1="${pageContext.request.contextPath}/order/toOrderStatistic?pageNo="+pageNo+"&pageSize="+select
                +"&orderNum="+orderNum+"&orderType="+orderType+"&type="+type;
    ...
    function previousPage() {
        ...
        var orderType = $("#orderType").val();
        var type = $("#type").val();
        var url2="${pageContext.request.contextPath}/order/toOrderStatistic?pageNo="+pageNo+"&pageSize="+select
                +"&orderNum="+orderNum+"&orderType="+orderType+"&type="+type;
    ...
    function nextPage() {
        ...
        var orderType = $("#orderType").val();
        var type = $("#type").val();
        var url3="${pageContext.request.contextPath}/order/toOrderStatistic?pageNo="+pageNo+"&pageSize="+select
                +"&orderNum="+orderNum+"&orderType="+orderType+"&type="+type;
    ...
    function tailPage() {
        ...
        var orderType = $("#orderType").val();
        var type = $("#type").val();
        var url4="${pageContext.request.contextPath}/order/toOrderStatistic?pageNo="+pageNo+"&pageSize="+select
                +"&orderNum="+orderNum+"&orderType="+orderType+"&type="+type;
