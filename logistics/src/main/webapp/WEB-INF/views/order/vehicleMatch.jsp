                                    ...
                                    <li>
                                        <div class="trade-services-table">
                                            ...
                                            <div style="margin-left: 45%;margin-bottom: 20px;">
                                                <a  class="btn btn-primary" href="#" onclick="subm()" >提交</a>
                                                <a  class="btn btn-primary" href="${pageContext.request.contextPath}/order/toOrderManagement" style="margin-left:10px">返回</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
